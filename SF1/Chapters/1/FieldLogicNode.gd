...
func get_char_tile_position() -> Vector2:
	# return tilemap.local_to_map(mc.global_position)
...
func get_tile_info_under_character(new_pos: Vector2):
	...
	#print("MC Kinematic", mc.get_node("CharacterRoot/CharacterBody2D").position)
	
	# print(mc.get_character_movement())
	# print(mc.get_node("CharacterBody2D").position)
	...
	# print(tilemap.local_to_map(mc.position))
	# print(tilemap.get_cellv(tilemap.local_to_map(mc.position)))
	# print(tilemap.tile_set.tile_get_name(tilemap.get_cellv(tilemap.local_to_map(mc.position))))
	
	# print(tilemap.local_to_map(mc_real_pos))
	# print(tilemap.get_cellv(tilemap.local_to_map(mc_real_pos)))
	# print(tilemap.tile_set.tile_get_name(tilemap.get_cellv(tilemap.local_to_map(mc_real_pos))))
