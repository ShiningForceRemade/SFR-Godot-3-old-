...
func attempt_to_interact() -> void:
	...
	Singleton_CommonVariables.dialogue_box_node.external_file = DefaultScript # "res://SF1/Chapters/1/Guardiana/PreInvasion/Scripts/OldManAtTheChurch.json"
...
func attempt_to_interact_test(script_path_arg: String) -> void:
	...
	Singleton_CommonVariables.dialogue_box_node.external_file = script_path_arg
	Singleton_CommonVariables.dialogue_box_node._process_new_resource_file()
