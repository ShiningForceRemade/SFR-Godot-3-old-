...
func attempt_to_interact() -> void:
	...
	if Singleton_Game_GlobalCommonVariables.sf_game_data_node.ForceMembers[idx].active_in_force:
		Singleton_Game_GlobalCommonVariables.dialogue_box_node.external_file = "res://SF1/Chapters/HQ/Default/Scripts/ActiveForceQuotes/Gong.json"
	else:
		Singleton_Game_GlobalCommonVariables.dialogue_box_node.external_file = "res://SF1/Chapters/HQ/Default/Scripts/InactiveForceQuotes/Gong.json"
