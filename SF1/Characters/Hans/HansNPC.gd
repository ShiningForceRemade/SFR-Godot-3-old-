...
func attempt_to_interact() -> void:
	...
	var idx = Singleton_Game_GlobalCommonVariables.sf_game_data_node.E_SF1_FM.HANS
	if Singleton_Game_GlobalCommonVariables.sf_game_data_node.ForceMembers[idx].active_in_force:
		Singleton_Game_GlobalCommonVariables.dialogue_box_node.external_file = "res://SF1/Chapters/HQ/Default/Scripts/ActiveForceQuotes/Hans.json"
	else:
		Singleton_Game_GlobalCommonVariables.dialogue_box_node.external_file = "res://SF1/Chapters/HQ/Default/Scripts/InactiveForceQuotes/Hans.json"
