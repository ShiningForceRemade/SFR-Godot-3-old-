...
@onready var char_animationPlayer = $CharacterWrapperMaybeMakethistsownScene/AnimationPlayer
...
func _ready():
	...
	Singleton_CommonVariables.battle_scene_node = self
	...
	# enemeySpriteTween.connect("tween_completed", Callable(self, "s_enemey_tween_completed"))
	# blackFadeTween.connect("tween_completed", Callable(self, "s_cleanup_black_fade_tween"))
...
func setup_character_and_enemey_sprites_idle() -> void:
	...
	if Singleton_CommonVariables.currently_active_character.get_actor_root_node_internal().actor_type == "character":
		char_actor_rn = Singleton_CommonVariables.currently_active_character.get_actor_root_node_internal()
	elif Singleton_CommonVariables.currently_selected_actor.get_actor_root_node_internal().actor_type == "character":
		char_actor_rn = Singleton_CommonVariables.currently_selected_actor.get_actor_root_node_internal()
...
func setup_actor_attacking() -> void:
	...
	await Signal(get_tree().create_timer(0.15), "timeout")
...
func s_cleanup_animation(animation_name_arg) -> void:
	...
	await Signal(self, "signal_battle_complete_damage_step")
...
func cleanup_battle_scene_completed() -> void:
	...
	Singleton_CommonVariables.currently_active_character.z_index = 0
	Singleton_CommonVariables.currently_selected_actor.z_index = 0
	...
	Singleton_CommonVariables.target_selection_node.target_range.cleanup_cursor()
...
func calculate_damage_step() -> void:
	var enemeyRoot = Singleton_CommonVariables.currently_selected_actor.get_node("EnemeyRoot")
	...
	# yield(get_tree().create_timer(1), "timeout")
	Singleton_CommonVariables.battle_base.targetActorMicroInfoRoot.display_micro_info_for_actor(Singleton_CommonVariables.currently_selected_actor)
	...
	await Signal(self, "signal_exp_phase_is_over")
...
func calculate_damage_step_enemey_attacking() -> void:
	...
	var enemeyRoot = Singleton_CommonVariables.currently_active_character.get_node("EnemeyRoot")
	var characterRoot = Singleton_CommonVariables.currently_selected_actor.get_node("CharacterRoot")
...
func setup_enemey_attacking_animation() -> void:
	var activeActorRoot = Singleton_CommonVariables.currently_active_character.get_actor_root_node_internal() # ENemeyRoot
...
func print_who_is_attacking() -> void:
	...
	var active_actor = Singleton_CommonVariables.currently_active_character.get_actor_root_node_internal() # get_node("CharacterRoot")
...
func print_enemey_actor_evaded() -> void:
	Singleton_CommonVariables.dialogue_box_node.show()
	var selected_actor = Singleton_CommonVariables.currently_selected_actor.get_node("EnemeyRoot")
...
func print_character_actor_evaded() -> void:
	Singleton_CommonVariables.dialogue_box_node.show()
	var selected_actor = Singleton_CommonVariables.currently_selected_actor.get_node("CharacterRoot")
...
func print_coins_and_items_receieved() -> void:
	...
	Singleton_CommonVariables.coins += selected_actor.coins
	await Signal(Singleton_CommonVariables.dialogue_box_node, "signal_dialogue_completed")
