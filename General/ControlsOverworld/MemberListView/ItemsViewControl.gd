...
func SetEquipMenuActiveForCharacter() -> void:
	...
	get_parent().get_parent().equipItemsControlNode.DisplayCharacterStats(Singleton_CommonVariables.selected_character)
...
func SetFindTargetOfGiveItem() -> void:
	# print(Singleton_Game_GlobalCommonVariables.selected_character.inventory, selected_item)
	Singleton_CommonVariables.selected_item = Singleton_CommonVariables.selected_character.inventory[selected_item]
	# TODO: clean var names to be clearer later
	Singleton_CommonVariables.selected_item_idx = selected_item
